...
public class NGramMap {
    ...
    public int countInYear(String word, int year){//needs to be immutable for all
    ...
    public TimeSeries<Integer> countHistory(String word, int startYear, int endYear){//need to check for weird start & end year

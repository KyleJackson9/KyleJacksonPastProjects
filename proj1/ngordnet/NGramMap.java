...
public class NGramMap {
    ...
    public YearlyRecord getRecord(int year){//put in string, Integer
        YearlyRecord answer = new YearlyRecord();
        for (String i : yMap.keySet()){
            //if ((yMap.get(i).get(year)) ! = null){
            answer.put(i,yMap.get(i).get(year));
        //}
        }
        return answer; 

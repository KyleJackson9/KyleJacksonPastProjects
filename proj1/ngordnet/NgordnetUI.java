        ...
        while (true) {
            ...
            switch (command) {
                ...
                case "help":
                    ...
                    System.out.println("I guess there is also wordlength and zipf[year]");
                    break;  
                case "range": 
                try {
                    ...
                    System.out.println("Sorry that input did not bode well for range");
                    break;
                  }
                case "count":
                try {
                ...
                try{
                    ...
                    plot.plotCategoryWeights(ng, wn, wordy3, startDate, endDate);
                      ...
                      plot.plotCategoryWeights(ng, wn, wordy3[0], startDate, endDate);
                    }
                  } catch (Throwable t){
                ...
                try{
                    ...
                    break;
                      ...
                      System.out.println("Sorry that input did not work for hypohist");
                      break;
                    }
                case "wordlength":
                try {
                    ...
                    System.out.println("Sorry maybe try putting correct start & end dates");
                    break;
                  }
                case "zipf":
                try {
                    ...
                    System.out.println("Sorry that input for Zipf did not go over well put in year perhaps");
                    break;
                  }
                default:
